...
import { setLocation, setView, setSeasons, setFacilities, setImages } from '../redux/modules/spotSlice';
...
const AddSpot = () => {
    ...
    const { location, view, seasons, facilities, images } = useSelector((state) => state.spot);
        ...
        <>
            <StForm onSubmit={handleSubmmit}>
                        ...
                        <StTag>
                            {VIEWS.map((view, index) => (
                                <TagSelection
                                    ...
                                    category='view'
                                    uid={uuid()}
                                    onClick={(tagName, category) => handleTagClick(tagName, category)}
                ...
                <StBox>
                    ...
                    <StTextarea value={content} onChange={handleAddContent} placeholder='차박 명소를 소개해주세요!' />
                </StBox>
                <StBox>
                    <label htmlFor='file'>
