...
export default function Signup() {
    ...
    const defaultavatar = 'https://www.pngarts.com/files/10/Default-Profile-Picture-PNG-Download-Image.png';
    ...
    return (
        <StsignupWrapper>
            ...
            <StbuttonSection>
                ...
                <Button text='회원가입 신청' type='button' onClick={handlersignup} width={'320px'} />
            </StbuttonSection>
        </StsignupWrapper>
    );
}
